...
# function.
entry.o : $(SOURCE_DIR)/entry.cpp $(SOURCE_DIR)/entry.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(SOURCE_DIR)/entry.cpp

sort.o : $(SOURCE_DIR)/sort.cpp $(SOURCE_DIR)/sort.h  $(SOURCE_DIR)/sort_definitions.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(SOURCE_DIR)/sort.cpp

entry_gTest.o : $(TEST_DIR)/entry_gTest.cpp $(SOURCE_DIR)/entry.h $(SOURCE_DIR)/sort.h $(SOURCE_DIR)/sort_definitions.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) -I$(SOURCE_DIR) $(CXXFLAGS) -c $(TEST_DIR)/entry_gTest.cpp

entry_gTest : entry.o sort.o entry_gTest.o gtest_main.a
